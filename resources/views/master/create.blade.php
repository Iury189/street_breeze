@section('title') {{'Cadastrar master'}} @endsection
                    ...
                    <form action="{{ url('add-master') }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-select id="nacionalidade" class="block w-full" name="nacionalidade" autofocus>
                                ...
                                <option {{ old('nacionalidade') == 'Estados Unidos da América' ? 'selected' : '' }} value="Estados Unidos da América">Estados Unidos da América</option>
